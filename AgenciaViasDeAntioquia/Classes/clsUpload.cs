...
namespace AgenciaViasDeAntioquia.Classes
{
    public class clsUpload
    {
        ...
        private string ProcesarArchivos(List<string> Archivos)
        {
            ...
            {
                case "PESAJE":
                    clsFotoPesaje FotoPesaje = new clsFotoPesaje();
                    FotoPesaje.idFotoPesaje = Datos;//Debe venir la información que se procesa en la base de datos, para nuestro caso, el código del producto
                    FotoPesaje.Archivos = Archivos;
                    return FotoPesaje.GrabarImagenes();
                default:
